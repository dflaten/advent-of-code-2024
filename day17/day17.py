...
def parse_input_into_registers_and_instructions(
    input,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--run_instructions",
        action="store_true",
        help="Run instructions on Chronospatial Computer",
    )
    parser.add_argument(
        "--generate_register_a",
        action="store_true",
        help="Generate Register A for program output",
    )
    args = parser.parse_args()
    register_a, register_b, register_c, instructions = (
        parse_input_into_registers_and_instructions(INPUT)
    )
